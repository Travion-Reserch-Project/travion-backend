...
import { validate, validateQuery, validateParams } from '../../../../shared/middleware/validator';
import {
  chatSchema,
  recommendSchema,
 ...
 * @access  Private
 */
router.post('/chat', authenticate as any, validate(chatSchema), aiEngineController.chat as any);
 ...
 * @access  Private
 */
router.get('/events/check-holiday', authenticate as any, aiEngineController.checkHoliday as any);
