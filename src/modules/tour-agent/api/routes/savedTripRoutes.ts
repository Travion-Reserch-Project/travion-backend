...
import { validate, validateParams, validateQuery } from '../../../../shared/middleware/validator';
import {
  createTripSchema,
  updateTripSchema,
  updateStatusSchema,
 ...
 * @access  Public
 */
router.get('/public', validateQuery(getTripsQuerySchema), tripController.getPublicTrips);
 ...
 * @access  Private
 */
router.get('/', validateQuery(getTripsQuerySchema), tripController.getTrips);
 ...
 * @access  Private
 */
router.get('/search', validateQuery(searchTripsQuerySchema), tripController.searchTrips);
 ...
 * @access  Private
 */
router.get('/:tripId', validateParams(tripIdParamSchema), tripController.getTripById);
 ...
 * @access  Private
 */
router.delete('/:tripId', validateParams(tripIdParamSchema), tripController.deleteTrip);
 ...
 * @access  Private
 */
router.post('/:tripId/duplicate', validateParams(tripIdParamSchema), tripController.duplicateTrip);
