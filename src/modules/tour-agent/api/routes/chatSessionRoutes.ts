 ...
 * @access  Private
 */
router.post('/quick', validate(quickChatSchema), chatController.quickChat);
 ...
 * @access  Private
 */
router.get('/sessions', validateQuery(getSessionsQuerySchema), chatController.getSessions);
 ...
 * @access  Private
 */
router.get('/sessions/:sessionId', validateParams(sessionIdParamSchema), chatController.getSession);
 ...
 * @access  Private
 */
router.post('/location', validate(locationChatSchema), chatController.locationChat);
