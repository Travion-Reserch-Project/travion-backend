...
import { AIEngineService } from '../../domain/services/AIEngineService';
...
export class AIEngineController {
   ...
   */
  getExplanation = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
   ...
   */
  getEventImpact = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
   ...
   */
  checkHoliday = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
   ...
   */
  getGoldenHour = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
   ...
   */
  getSunPosition = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
   ...
   */
  checkHealth = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
   ...
   */
  checkAvailability = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
   ...
   */
  getLocationInfo = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      const { location } = req.params;
   ...
   */
  getSimpleDescription = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const { location_name, preference } = req.body;

      const result = await this.aiEngineService.getSimpleDescription(location_name, preference);
