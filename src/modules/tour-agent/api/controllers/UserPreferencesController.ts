...
export class UserPreferencesController {
  ...
  updatePreferenceScores = async (
    ...
    try {
      const userId = this.getUserId(req);
      const preferences = await this.preferencesService.updatePreferenceScores(userId, req.body);
  ...
  updateTravelStyle = async (
    ...
    try {
      const userId = this.getUserId(req);
      const preferences = await this.preferencesService.updateTravelStyle(userId, req.body);
   ...
   */
  saveLocation = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      const userId = this.getUserId(req);
  ...
  removeSavedLocation = async (
    ...
    try {
      ...
      const preferences = await this.preferencesService.removeSavedLocation(userId, locationId);
   ...
   */
  isLocationSaved = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      const userId = this.getUserId(req);
      const { locationId } = req.params;
   ...
   */
  getSearchHistory = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      const userId = this.getUserId(req);
   ...
   */
  addSearchHistory = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      const userId = this.getUserId(req);
      const preferences = await this.preferencesService.addSearchHistory(userId, req.body);
   ...
   */
  updateCategories = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      const userId = this.getUserId(req);
      const preferences = await this.preferencesService.updateCategories(userId, req.body);
  ...
  addFavoriteCategory = async (
    ...
    try {
      ...
      const preferences = await this.preferencesService.addFavoriteCategory(userId, category);
  ...
  removeFavoriteCategory = async (
    ...
    try {
      const userId = this.getUserId(req);
      const { category } = req.params;
      const preferences = await this.preferencesService.removeFavoriteCategory(userId, category);
  ...
  markLocationVisited = async (
    ...
    try {
      ...
      const preferences = await this.preferencesService.markLocationVisited(userId, locationId);
  ...
  unmarkLocationVisited = async (
    ...
    try {
      const userId = this.getUserId(req);
      const { locationId } = req.params;
      const preferences = await this.preferencesService.unmarkLocationVisited(userId, locationId);
  ...
  updateHomeLocation = async (
    ...
    try {
      const userId = this.getUserId(req);
      const preferences = await this.preferencesService.updateHomeLocation(userId, req.body);
